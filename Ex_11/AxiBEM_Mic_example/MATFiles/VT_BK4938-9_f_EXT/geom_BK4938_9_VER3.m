function [rzb38,topology38,rzline38,IndMb38,IndBP38,Mmb38,M38,N38,Tm38,mu_m38,...
          ...
          rzbEXT,topologyEXT,Mext,Next,IndMbEXT,MmbEXT]=geom_BK4938_9_VER3(MeshDens,varargin)
...
% It admits a second input, the sub-version:
%  -'a' or nothing: original geometry
%  -'b' : modified geometry of the 4939 at some point of the backcavity,
%  using 2 Bézier segments.
...
segments4938=[0 Hgh Rad Hgh 24 0 MeshDens;...
          ...
          BPrad 0 0 0 21 0 MeshDens];
if s_ver=='b'
% One of the cavity corners has been corrected to be oblique      
    segments4939=[0 Hgh Rad Hgh 24 0 MeshDens;...
          Rad Hgh Rad+Rc Hgh-Rc 5 Rc MeshDens;...
          Rad+Rc Hgh-Rc Rad+Rc -0.7e-3+Rc 4 0 MeshDens;...
          Rad+Rc-j*(0.7e-3-Rc) Rad+Rc-j*0.7e-3 Rad+Rc-j*0.7e-3 1.9e-3-j*0.75e-3 5 0 MeshDens;...
          1.9e-3-j*0.75e-3 1.8e-3-j*0.8e-3 1.8e-3-j*0.8e-3 1.8e-3-j*(0.8e-3+Rc) 5 0 MeshDens;...
          1.8e-3 -0.8e-3-Rc 1.8e-3 -3.5e-3+Rc 6 0 MeshDens;...
...
% % Old geometries
% segments4938=[0 Hgh Rad Hgh 24 0;...
%           Rad Hgh Rad -0.7e-3 4 0;...
%           Rad -0.7e-3 1.8e-3 -0.8e-3 2 0;...
%           1.8e-3 -0.8e-3 1.8e-3 -1.5e-3 4 0;...
%           1.8e-3 -1.5e-3 1.3e-3 -1.5e-3 3 0;...
%           1.3e-3 -1.5e-3 1.3e-3 -0.5e-3 4 0;...
%           1.3e-3 -0.5e-3 BPrad -0.5e-3 3 0;...
%           BPrad -0.5e-3 BPrad 0 3 0;...
%           BPrad 0 0 0 21 0];
% segments4939=[0 Hgh Rad Hgh 24 0 MeshDens;...
%           Rad Hgh Rad -0.7e-3 3 0 MeshDens;...
%           Rad -0.7e-3 1.8e-3 -0.8e-3 2 0 MeshDens;...
%           1.8e-3 -0.8e-3 1.8e-3 -3.5e-3 6 0 MeshDens;...
%           1.8e-3 -3.5e-3 1.3e-3 -3.5e-3 2 0 MeshDens;...
%           1.3e-3 -3.5e-3 1.3e-3 -3.1e-3 2 0 MeshDens;...
%           1.3e-3 -3.1e-3 1.2e-3 -3.1e-3 2 0 MeshDens;...
%           1.2e-3 -3.1e-3 1.2e-3 -0.9e-3 5 0 MeshDens;...
%           1.2e-3 -0.9e-3 1.3e-3 -0.9e-3 2 0 MeshDens;...
%           1.3e-3 -0.9e-3 1.3e-3 -0.5e-3 2 0 MeshDens;...
%           1.3e-3 -0.5e-3 BPrad -0.5e-3 2 0 MeshDens;...
%           BPrad -0.5e-3 BPrad 0 2 0 MeshDens;...
%           BPrad 0 0 0 21 0 MeshDens];
