function [F4A,F4B,CK]=intF4_quad(pxyzb,elknxyzb,Tole)

%  [F4A,F4B,CK]=intF4_quad(pxyzb,elknxyzb,Tole)
%  
...
n=4; % Gaussrule order (it used to be 8, but in this case 4 can be sufficient)

IPF=nsing2dQUAD(n,pxyzb,elknxyzb,Tole);
...
disp(['Near-singular integration, ' num2str(size(IPF,1)) ' points']);
