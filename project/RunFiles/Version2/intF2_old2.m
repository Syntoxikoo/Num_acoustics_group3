function [Bcontrib,Acontrib,CK]=intF2(przb,elknrzb,m,varargin)
...
%    is_vt:   flag to indicate visco-thermal calculation (optional)
%
%  Output:
...
if nargin>3 % flag to indicate visco-thermal calculation 
    is_vt=varargin{1};
else
    is_vt=0;
end
