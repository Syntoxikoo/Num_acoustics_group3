...
%     -B�zier segment: the four coordinates in the first four columns of 
%                "segments" become the four points of a cubic B�zier curve,
...
%                *B�zier and B-Spline Techniques (Berlin:Springer)

% -Vicente Cutanda Henr�quez 1995 
% -Translation from Pascal to Matlab: Johan Gramtorp 2000
% -Vicente Cutanda Henr�quez: help text 2004, inline function segments
% 2007, rzline 2010.
% Vicente Cutanda Henr�quez, rzline addition, 04-2011
% Vicente Cutanda Henr�quez, varying element length, B�zier segments, 06-2011
% Vicente Cutanda Henr�quez, objects not attached to the z-axis, 05-2014
% Vicente Cutanda Henr�quez, Output corresponding segment numbers. Common
...
for m=m_re';	% For every segment with uniform element length
    ...
    if ~isreal([rho_start z_start rho_end z_end]) % B�zier curve with extra points as imaginary parts
        % B�zier curves:
        ...
        % Cubic B�zier curve, parametric form
...
%             end
            % decide which curvature centre will be used
            vecseg=[rho_end-rho_start z_end-z_start 0]; % Sometimes it does not work, changed back to the previous version
