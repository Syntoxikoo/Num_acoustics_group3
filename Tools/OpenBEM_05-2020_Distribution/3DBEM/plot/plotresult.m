...
if nknel==8
   ...
   hold off;
elseif nknel==6
%    patch('faces',topology(:,[1 2 3]),'vertices',xyz,'FaceVertexCData',result,'FaceColor','interp','LineStyle','-');
   patch('faces',topology(:,[1 4 6]),'vertices',xyz,'FaceVertexCData',result,'FaceColor','interp','LineStyle',':');
   hold on;
   patch('faces',topology(:,[2 5 4]),'vertices',xyz,'FaceVertexCData',result,'FaceColor','interp','LineStyle',':');
   patch('faces',topology(:,[3 6 5]),'vertices',xyz,'FaceVertexCData',result,'FaceColor','interp','LineStyle',':');
   patch('faces',topology(:,[6 4 5]),'vertices',xyz,'FaceVertexCData',result,'FaceColor','interp','LineStyle',':');
   hold off;
else
