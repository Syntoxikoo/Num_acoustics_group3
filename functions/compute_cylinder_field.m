function [p_i,p_s] = compute_cylinder_field(x,y,a,f,k,p0,M,coords,t, center) % Compute the pressure field around an infinite cylinder for an incoming plane wave. 
% Input:
